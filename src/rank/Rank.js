...
module.exports = class RankCard {
  constructor() {
    ...
    this.opacityAvatar = "0.7";
    this.opacityBadges = "0.7";
    this.opacityLevel = "1";
    this.opacityBackgroundBar = "0.7";
    this.opacityReputation = "1";
    this.opacityNoBadges = "0.7";
    this.textLevel = "Nivel {level}";
    this.textNeededXp = "{current}/{needed} para el siguiente rango";
