...
module.exports = class Leaves {
    ...
    async toAttachment() {
        ...
        const bordes = await Canvas.loadImage('https://i.ibb.co/YybQTSz/leave.png');
        ...
        // Draw avatar circle
            const borde1 = await Canvas.loadImage('https://i.ibb.co/Pm8BmxV/leaveborder.png');
            ...
            const borde = await Canvas.loadImage('https://i.ibb.co/Pm8BmxV/leaveborder.png');
