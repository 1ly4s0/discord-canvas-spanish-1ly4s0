...
module.exports = class Promotes {
    ...
    async toAttachment() {
        ...
        const bordes = await Canvas.loadImage('https://i.ibb.co/N69YyJ5/promote.png');
        ...
        // Draw avatar circle
            const borde1 = await Canvas.loadImage('https://i.ibb.co/vQbm34S/promoteborder.png');
            ...
            const borde = await Canvas.loadImage('https://i.ibb.co/vQbm34S/promoteborder.png');
